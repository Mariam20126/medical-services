...
class SpsializationNumberOneDetails extends StatefulWidget {
  DoctorsSpisializationOne spsialization;

  SpsializationNumberOneDetails({required this.spsialization});

  var dayAppointmentController = TextEditingController();
  var timeAppointmentController = TextEditingController();

  @override
  _SpsializationNumberOneDetailsState createState() =>
      _SpsializationNumberOneDetailsState();
}

class _SpsializationNumberOneDetailsState
    extends State<SpsializationNumberOneDetails> {
        ...
        body: SingleChildScrollView(
          child: Stack(alignment: Alignment.bottomCenter, children: [
            Column(
              children: [
                doctorList(
                  image: widget.spsialization.image,
                  name: widget.spsialization.name,
                  numRating: widget.spsialization.rate,
                  splization: widget.spsialization.spalization,
                  location: widget.spsialization.location,
                ),
                const SizedBox(
                  height: 15,
                ),
                            ...
                            onTap: () {
                              if (formKey.currentState?.validate() == true) {
                                final appointment = Appointment(
                                  name: widget.spsialization.name,
                                  specialization:
                                      widget.spsialization.spalization,
                                  rate: widget.spsialization.rate,
                                  location: widget.spsialization.location,
